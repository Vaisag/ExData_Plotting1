plot4 <- function() {
  ...
  with(tabAll,
       {
         plot(DateTimeNow, Global_active_power,ylab = "Global Active Power",xlab = "", type="l")
         plot(DateTimeNow, Voltage,ylab = "Voltage",xlab = "DateTime", type="l")
  plot(DateTimeNow,tabAll$Sub_metering_1,ylab = "Energy sub metering",xlab="",type="n")
  ...
  plot(DateTimeNow, Global_reactive_power,ylab = "Global_reactive_power",xlab = "DateTime", type="l")
       })
  dev.off()
}
